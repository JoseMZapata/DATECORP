...
<head>
    ...
    <title>Actividad Dibujo Creativo</title>
    ...
    <main class="ContenidoPrincipalArte">
        <div class="ContenidoPrincipalArte1">
            <div class="ContenidoPrincipalArte1--hijos">
                <div>
                    <img loading="lazy" src="img/imagen1234.jpg" alt="CursoSobreArte">
                </div>
                
            </div>
            <div class="ContenidoPrincipalArte2--hijos">
                <div>
                    <h2>Actividad Dibujo Creativo</h2>
                </div>
                <div>
                    <p>Dibujo sobre algo que te inspire y motive</p>
                </div>
