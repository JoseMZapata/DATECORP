...
<head>
    ...
    <title>Tecnicas sobre el dibujo</title>
    ...
    <main class="ContenidoPrincipalArte">
        <div class="ContenidoPrincipalArte1">
            <div class="ContenidoPrincipalArte1--hijos">
                <div>
                    <img loading="lazy" src="img/tarea123.jpeg" alt="CursoSobreArte">
                </div>
                
            </div>
            <div class="ContenidoPrincipalArte2--hijos">
                <div>
                    <h2>Tecnicas sobre el dibujo</h2>
                </div>
                <div>
                    <p>Un dibujo aplicando tecnicas de dibujo vistos en la asesoria</p>
                </div>
